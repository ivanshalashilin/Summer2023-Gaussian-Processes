...
likelihood = likelihood.replace_trainable(obs_noise=False) #we train it without noise?
...
negative_mll(no_opt_posterior, train_data=D) #construct the mll based on the posterio
negative_mll = jit(negative_mll)

opt_posterior, history = gpx.fit(
    model=no_opt_posterior, #where the parameters are stored
    objective=negative_mll, #we minimise the objective function wrt to the parameters
    train_data=D,
